...
function my_bp_activity_entry_meta() {
    ...
    <?php }
        ...
        <a class="view-thread" href="<?php bp_activity_thread_permalink() ?>">View Discussion Thread</a>
    <?php }
 
        if ( bp_get_activity_object_name() == 'groups' && bp_get_activity_type() == 'new_forum_post' ) {?>
        <a class="view-post" href="<?php bp_activity_thread_permalink() ?>">View Discussion Post</a>
    <?php }
