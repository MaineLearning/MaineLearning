...
function wpv_admin_import_form($file_name) {
	...
	<form name="View_import" enctype="multipart/form-data" action="" method="post">
		<?php if($file_name != ''): ?>
			<h2><?php _e('Import Views and View Templates for your Theme', 'wpv-views'); ?></h2>
		<?php else: ?>
			<h2><?php _e('Import Views and View Templates', 'wpv-views'); ?></h2>
		<?php endif; ?>
		
		<p><strong><?php _e('Settings:', 'wpv-views'); ?></strong></p>
		<ul style="margin-left:10px">
			...
			<li>
				...
				<label for="checkbox-3"><?php _e('Bulk overwrite if View Template exists', 'wpv-views'); ?></label>
			</li>
			<li>
				<input id="checkbox-4" type="checkbox" name="view-templates-delete" />
				<label for="checkbox-4"><?php _e('Delete any existing View Templates that are not in the import', 'wpv-views'); ?></label>
			</li>
		</ul>
