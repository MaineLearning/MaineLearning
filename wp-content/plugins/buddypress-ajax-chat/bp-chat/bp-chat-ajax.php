 ...
 * 
 * 			jQuery.post( ajaxurl, {
 *				action: 'my_chat_action',
 *				'cookie': encodeURIComponent(document.cookie),
 *				'parameter_1': 'some_value'
 *			}, function(response) { ... } );
 *
 * Notice the action 'my_chat_action', this is the part that will hook into the wp_ajax action.
 * 
 * You will need to add an add_action( 'wp_ajax_my_chat_action', 'the_function_to_run' ); so that
 ...
 *
 * Below is an chat of the addremove_friend AJAX action in the friends component.
 */

function chat_friends_ajax_addremove_friend() {
	global $bp;
