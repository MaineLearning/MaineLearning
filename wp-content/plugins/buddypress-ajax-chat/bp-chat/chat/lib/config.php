...
// Database hostname:
$config['dbConnection']['host'] = $bp_chat_config_db_host;
// Database username:
$config['dbConnection']['user'] = $bp_chat_config_user;
// Database password:
$config['dbConnection']['pass'] = $bp_chat_config_pass;
// Database name:
$config['dbConnection']['name'] = $bp_chat_config_db;
// Database type:
...
// Default language:
$config['langDefault'] = $bp_chat_config_language;
// Language names:
