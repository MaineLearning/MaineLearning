...
function bpe_get_events( $args = '' )
{
	...
	$events = Buddyvents_Events::get( $ids, (int)$user_id, (int)$group_id, $name, $slug, $start_date, $start_time, $end_date, $end_time, $timezone, $day, $month, $year, $future, $past, $location, $venue_name, $venue, (bool)$map, $radius, $longitude, $latitude, (int)$public, (int)$rsvp, $category, $meta, $meta_key, $operator, $begin, $end, (int)$page, (int)$per_page, $search_terms, (bool)$populate_extras, $sort, (bool)$restrict, $spam, (int)$approved, (int)$group_approved );
