...
class Buddyvents_Event_Template
{
	...
	function __construct( $ids, $user_id, $group_id, $name, $slug, $start_date, $start_time, $end_date, $end_time, $timezone, $day, $month, $year, $future, $past, $location, $venue_name, $venue, $map, $radius, $longitude, $latitude, $public, $rsvp, $category, $meta, $meta_key, $operator, $begin, $end, $page, $per_page, $max, $search_terms, $populate_extras, $sort, $restrict, $spam, $approved, $group_approved )
	{
...
function bpe_has_events( $args = '' )
{
	...
	$event_template = new Buddyvents_Event_Template( $ids, (int)$user_id, (int)$group_id, $name, $slug, $start_date, $start_time, $end_date, $end_time, $timezone, $day, $month, $year, $future, $past, $location, $venue_name, $venue, (bool)$map, $radius, $longitude, $latitude, (int)$public, (int)$rsvp, (int)$category, $meta, $meta_key, $operator, $begin, $end, (int)$page, (int)$per_page, (int)$max, $search_terms, (bool)$populate_extras, $sort, (bool)$restrict, $spam, (int)$approved, (int)$group_approved );
