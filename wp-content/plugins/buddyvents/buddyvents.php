...

{
...

	{
		...
		add_action( 'plugins_loaded', array( &$this, 'check_requirements' ),  3	);
...

	{
		...
		if( count( $warnings ) > 0 ) :
			...
			add_action( 'admin_notices', create_function( '', 'printf( Buddyvents::messages( \'warnings\' ), Buddyvents::$warnings );'	) );
